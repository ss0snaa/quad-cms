...
<div class="container">
    <div class="row">
        <h1 class="text-center topic">Подробная информация профиля <?= $data['username']; ?></h1>
    </div><br>
    <div class="row">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="<?= $data['battlelog_link']; ?>" target="_blank"><button class="btn btn-primary btn-xs">ПЕРЕЙТИ</button> </a> </td>
                    </tr>
                    <tr>
                        <td colspan="2" style="text-align: center"><a href="/profile/edit/"><button class="btn btn-primary btn-xs">ИЗМЕНИТЬ ДАННЫЕ</button> </a> </td>
                    </tr>
                </tbody>
            </table>
        </div>
